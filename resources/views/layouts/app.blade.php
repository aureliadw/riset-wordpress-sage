...
<body @php(body_class())>
  @php(wp_body_open())
  <div style="z-index: 999" id="global-loader"
    class="fixed inset-0 flex items-center justify-center bg-gray-700 opacity-60 transition-opacity duration-200 hidden">
    <div role="status">
